...
ctx.lineWidth = 5;
ctx.arc(x = 350, y = 350, r = 210, startAngle = 0, endAngle = 2*Math.PI);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x = 350, y = 300, r = 250, startAngle = 0,endAngle = 2*Math.PI);
ctx.stroke();
// Similarly, create a green circle with position 400 and 250
ctx.beginPath;
ctx.strokeStyle = "green";
ctx.lineWidth = 5;
ctx.arc(x = 350, y = 400, r = 250, startAngle = 0,endAngle = 2*Math.PI);
ctx.stroke();